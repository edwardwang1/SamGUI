    ...
    public partial class ColorSlider : Control
    {
                                     ...
                                     Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                int customThumbSize = 50;
                if (barOrientation == Orientation.Horizontal)
                {
                    int TrackX = (((trackerValue - barMinimum) * (ClientRectangle.Width - customThumbSize)) / (barMaximum - barMinimum));
                    thumbRect = new Rectangle(TrackX, 1, customThumbSize, customThumbSize);
                }
                else
                {
                    int TrackY = (((trackerValue - barMinimum) * (ClientRectangle.Height - thumbSize)) / (barMaximum - barMinimum));
                    thumbRect = new Rectangle(1, TrackY, ClientRectangle.Width - 3, ClientRectangle.Width - 3);
                }
                ...
                //custom draw thumb
                Image thumb = Image.FromFile("C:\\Users\\user\\Desktop\\SamGUI\\CustomSeekbar\\Resources\\sliderthumb.png");
